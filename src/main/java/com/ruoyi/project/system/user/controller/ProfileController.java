...
public class ProfileController extends BaseController {
     ...
     * 上传图片
     */
    @GetMapping("/cardimg/{userId}")
    public String cardimg(@PathVariable("userId") Long userId, ModelMap mmap) {
        mmap.put("user", userService.selectUserById(userId));
        return prefix + "/cardimg";
    }
    ...
    @ResponseBody
    public AjaxResult updateAvatar(@RequestParam("avatarfile") MultipartFile file, @RequestParam("userId") Long userId) {
        User user = getSysUser();
        try {
            String avatar = "";
            if (!file.isEmpty()) {
