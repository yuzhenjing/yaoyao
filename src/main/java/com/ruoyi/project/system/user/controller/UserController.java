...
public class UserController extends BaseController {
    ...
    public AjaxResult addSave(User user) {
        ...
        BeanUtils.copyProperties(user, contract);
        contract.setUserId(user.getUserId());
        contract.setContractNo(contract.getContractNo());
    ...
    public String edit(@PathVariable("userId") Long userId, ModelMap mmap) {
        ...
        final Contract contract = contractService.selectContractById(userId);
        BeanUtils.copyProperties(contract, user);
        mmap.put("user", user);
    ...
    public String details(@PathVariable("userId") Long userId, ModelMap mmap) {
        final User user = userService.selectUserById(userId);
        final Contract contract = contractService.selectContractById(userId);
        BeanUtils.copyProperties(contract, user);
        mmap.put("user", user);
